...
const site=path.resolve(process.argv[2]||'.work/site');
...
(async()=>{
 ...
 for(const year of Object.keys(manifest.periods)){
 ...
 console.log('Real release data and ranking verification passed.');
